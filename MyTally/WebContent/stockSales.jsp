		...
		success : function(x){
			...
			if(list.length>0){
	        	...
	        	for(var i=0;i<list.length;i++){    
		            ...
		            c7.innerHTML = "<form method='post' action='<%=request.getContextPath()%>/sales?ch=delete&n="+list[i].salesInvoiceNo+"'><button class='fa fa-times' aria-hidden='true' ></button></form>";
				}
			}
			else{
...
<tr id="thead">
		<td colspan="7"><h3>Sales Invoices of &nbsp;<i style="color:#00aba9" >'${param.name}'</i></h3></td>
	</tr>
