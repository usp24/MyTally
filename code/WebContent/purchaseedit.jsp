...
<link rel="stylesheet" href="css/purchaseedit.css">
...
$(document).ready(function(){
	...
	$.ajax({
		...
		success : function(x){
			...
			for(var i=1;i<list3.length;i++){
				...
				c4.innerHTML = "<input type='number' name='purchaseItemQty"+cnt+"' id='q"+cnt+"' onkeyup='fn("+cnt+")' value='"+list3[i].itemQty+"' autocomplete='off' >";
				...
				c7.innerHTML = "<input type='number' name='ItemGST"+cnt+"' id='gst"+cnt+"' value='"+list3[i].itemGST+"'  autocomplete='off' ><input type='text' value='%' readonly>";
				c8.innerHTML = "<input type='number' name='purchaseItemUnitPrice"+cnt+"' id='p"+cnt+"' onkeyup='fn("+cnt+")' value='"+list3[i].itemPurchasePrice+"'  autocomplete='off' >";
				c9.innerHTML = "<input type='number' name='purchaseItemDiscount"+cnt+"' onblur='fn("+cnt+")' id='d"+cnt+"' value='"+list3[i].itemSalesPrice+"'  autocomplete='off' ><input type='text' value='%' readonly>";
				c10.innerHTML = "<input type='number' name='purchaseItemTotalAmount"+cnt+"' id='amt"+cnt+"' readonly>";
	...
	$.ajax({
		...
		success : function(x){
			...
			name.value = list4[0][0].supplierName;
			add1.value = list4[0][0].supplierAddress1;
			add2.value = list4[0][0].supplierAddress2;
			city.value = list4[0][0].supplierCity;
			statecode.value = list4[0][0].supplierStatecode;
			gst.value = list4[0][0].supplierGSTNo;
			narration.value = list4[1][0].narration;
			if(list4[1][0].purchaseIGST == "YES"){
				rdyes.checked = true;
				rdno.checked = false;
			}
			else{
...
function fb(){
	...
	c7.innerHTML = "<input type='number' name='ItemGST"+cnt+"' id='gst"+cnt+"' value='28'  autocomplete='off' ><input type='text' value='%' readonly>";
...
<div id="form1" >
	...
	<div class="boxName" >Purchase Invoice Number* </div><input type="text" name="purchaseInvoiceNumber" id="iv" value="${param.ivn}" autocomplete='off' style="text-transform: uppercase;">
...
<tr>
	...
	<td><input type="number" name="purchaseItemQty1" id="q1" onkeyup="fn('1')" autocomplete='off' ></td>
	...
	<td><input type="number" name="ItemGST1" id="gst1" value="28"  autocomplete='off' ><input type="text" value="%" readonly></td>
...
<div>Is This Bill Contains IGST ? <input type="radio" name="IGSTRadio" id="rdyes" value="yes"> Yes &nbsp;&nbsp; <input type="radio" name="IGSTRadio" id="rdno" value="no"> No</div>
