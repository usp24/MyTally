...
window.onafterprint = function() {
	...
	document.getElementById("backIMG1").style.display='none';
...
function p(x){
	...
	document.getElementById("backIMG1").style.display='';
...
<table class="item" cellspacing="0">
	...
	<% int z=1; %>	
	<c:forEach var="i" begin="0" end="${param.num + 1}" items="${sessionScope.item}">
	<tr id="data" >
...
<div class="footer1" >
	...
	<div id="sign" >
		<div id="signline1" >for,${u.businessName}</div>
		<br>
		<br>
...
<div id="container"><center>
<img src="img/back.jpg" id="backIMG1" style="display: none;">
<div class="header1">
	<div id="copy2" style="font-size: 13px;padding-left: 5px;padding-top:5px;float: left;"></div>
	<div id="head">TAX INVOICE</div>
</div>
